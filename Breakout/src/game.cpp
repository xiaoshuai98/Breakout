...
{
    // load shaders
    ResourceManager::LoadShader(FileSystem::getPath("src/sprite.vs").c_str(), FileSystem::getPath("src/sprite.fs").c_str(), nullptr, "sprite");
    ResourceManager::LoadShader(FileSystem::getPath("src/particle.vs").c_str(), FileSystem::getPath("src/particle.fs").c_str(), nullptr, "particle");
    ResourceManager::LoadShader(FileSystem::getPath("src/post_processing.vs").c_str(), FileSystem::getPath("src/post_processing.fs").c_str(), nullptr, "postprocessing");
    // configure shaders
